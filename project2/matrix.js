...
Matrix.prototype = {
  ...
  multiply: function(m2, bAppend = true) {
    ...
    // TODO - multiply the two matrixes (ie., this and m2) into the newMat matrix
    //      - Note that AB != BA with matrix mutliplication so make sure
    //        you are doing it in the right order.
